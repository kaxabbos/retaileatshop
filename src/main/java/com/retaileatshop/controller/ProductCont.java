...
public class ProductCont extends Attributes {
    ...
    @PostMapping("/add")
    String productAddNew(Model model, @RequestParam MultipartFile img, @RequestParam String name, @RequestParam Category category, @RequestParam int quantity, @RequestParam int min, @RequestParam int price, @RequestParam Long warehouse, @RequestParam int weight, @RequestParam int keep, @RequestParam String description) {
        Product product = productRepo.saveAndFlush(new Product(name, category, price, quantity, weight, keep, description, min));
    ...
    @PostMapping("/edit/{id}")
    String productEditOld(@PathVariable Long id, Model model, @RequestParam MultipartFile img, @RequestParam String name, @RequestParam Category category, @RequestParam int quantity, @RequestParam int min, @RequestParam int price, @RequestParam Long warehouse, @RequestParam int weight, @RequestParam int keep, @RequestParam String description) {
