...
public class Attributes extends Main {
    ...
    protected void AddAttributesStats(Model model) {
        ...
        for (Product i : products) {
            profitPrice += i.getStat().getPrice();
            profitQuantity += i.getStat().getQuantity();
        ...
        model.addAttribute("profitPrice", profitPrice);
        model.addAttribute("profitQuantity", profitQuantity);
